      ...
      (user.id !== isConDeleted.sender_id &&
        ...
        >
          {({
            ...
            const handleAutoMessages = async (msg) => {
              try {
                await setFieldValue("message", msg);
                hanleSubmit();
              } catch (error) {
                coole.log(error);
              }
            ...
            return (
              <>
                <View>
                  ...
                  >
                    <TouchableOpacity
                      onPress={() => handleAutoMessages("Please call me")}
                      activeOpacity={0.8}
                    ...
                    <TouchableOpacity
                      onPress={() =>
                        handleAutoMessages("Is this item still available?")
                      }
                      activeOpacity={0.8}
                      style={styles.chatCard}
                    >
                      <Text>Is this item still available?</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      onPress={() => handleAutoMessages("Last Price")}
                      activeOpacity={0.8}
                      style={styles.chatCard}
                    >
                    ...
                    <TouchableOpacity
                      onPress={() =>
                        handleAutoMessages("Im interrested in this Ad")
                      }
                      activeOpacity={0.8}
                      style={styles.chatCard}
                    >
                      <Text>Im interrested in this Ad</Text>
                    </TouchableOpacity>
                  </ScrollView>
                </View>
